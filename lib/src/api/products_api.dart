...
class ProductsApi {
  ...
  Future<Response<ProductResponseDto>> createProduct({ 
    ...
    final _path = r'/api/canary/products';
...
_responseData = rawData == null ? null : deserialize<ProductResponseDto, ProductResponseDto>(rawData, 'ProductResponseDto', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListProductsResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListProductsResponseDto>> listProducts({ 
    ...
    ListProductsResponseDto? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ListProductsResponseDto, ListProductsResponseDto>(rawData, 'ListProductsResponseDto', growable: true);
    ...
    return Response<ListProductsResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ProductResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProductResponseDto>> retrieveProduct({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/canary/products/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ProductResponseDto, ProductResponseDto>(rawData, 'ProductResponseDto', growable: true);
  ...
  Future<Response<Object>> updateProduct({ 
    ...
    try {
_bodyData=jsonEncode(updateProductDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
