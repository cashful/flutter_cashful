...
class CustomersApi {
  ...
  Future<Response<CustomerResponseDto>> createCustomer({ 
    required CreateCustomerDto createCustomerDto,
    ...
    final _path = r'/api/canary/customers';
    ...
    try {
_bodyData=jsonEncode(createCustomerDto);
...
_responseData = rawData == null ? null : deserialize<CustomerResponseDto, CustomerResponseDto>(rawData, 'CustomerResponseDto', growable: true);
  ...
  Future<Response<CustomerBalanceDto>> getCustomerBalance({ 
    ...
    final _path = r'/api/canary/customers/{id}/balance'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<CustomerBalanceDto, CustomerBalanceDto>(rawData, 'CustomerBalanceDto', growable: true);
  ...
  Future<Response<ListCustomerPaymentMethodsResponseDto>> listCustomerPaymentMethods({ 
    ...
    final _path = r'/api/canary/customers/{id}/payment-methods'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<ListCustomerPaymentMethodsResponseDto, ListCustomerPaymentMethodsResponseDto>(rawData, 'ListCustomerPaymentMethodsResponseDto', growable: true);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListCustomerTransactionsResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListCustomerTransactionsResponseDto>> listCustomerTransactions({ 
    required String id,
    num? limit,
    num? offset,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/canary/customers/{id}/transactions'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ListCustomerTransactionsResponseDto? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ListCustomerTransactionsResponseDto, ListCustomerTransactionsResponseDto>(rawData, 'ListCustomerTransactionsResponseDto', growable: true);
    ...
    return Response<ListCustomerTransactionsResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [search] - Search across customer fields
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ListCustomersResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ListCustomersResponseDto>> listCustomers({ 
    ...
    ListCustomersResponseDto? _responseData;

    try {
final rawData = _response.data;
_responseData = rawData == null ? null : deserialize<ListCustomersResponseDto, ListCustomersResponseDto>(rawData, 'ListCustomersResponseDto', growable: true);
    ...
    return Response<ListCustomersResponseDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CustomerResponseDto>> retrieveCustomer({ 
    ...
    final _path = r'/api/canary/customers/{id}'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<CustomerResponseDto, CustomerResponseDto>(rawData, 'CustomerResponseDto', growable: true);
  ...
  Future<Response<CustomerResponseDto>> updateCustomer({ 
    ...
    try {
_bodyData=jsonEncode(updateCustomerDto);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
