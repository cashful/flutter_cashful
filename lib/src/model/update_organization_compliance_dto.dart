...
part 'update_organization_compliance_dto.g.dart';
...
class UpdateOrganizationComplianceDto {
  /// Returns a new [UpdateOrganizationComplianceDto] instance.
  ...
  final UpdateOrganizationComplianceDtoCurrentStepEnum? currentStep;
  ...
  final UpdateOrganizationComplianceDtoStatusEnum? status;
  ...
  final num? completionScore;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UpdateOrganizationComplianceDto &&
  ...
  factory UpdateOrganizationComplianceDto.fromJson(Map<String, dynamic> json) => _$UpdateOrganizationComplianceDtoFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateOrganizationComplianceDtoToJson(this);
...
enum UpdateOrganizationComplianceDtoCurrentStepEnum {
...
const UpdateOrganizationComplianceDtoCurrentStepEnum(this.value);
...
enum UpdateOrganizationComplianceDtoStatusEnum {
@JsonValue(r'pending')
pending(r'pending'),
...
const UpdateOrganizationComplianceDtoStatusEnum(this.value);
