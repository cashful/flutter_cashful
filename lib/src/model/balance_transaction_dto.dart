...
part 'balance_transaction_dto.g.dart';
...
class BalanceTransactionDto {
  ...
  factory BalanceTransactionDto.fromJson(Map<String, dynamic> json) => _$BalanceTransactionDtoFromJson(json);

  Map<String, dynamic> toJson() => _$BalanceTransactionDtoToJson(this);
